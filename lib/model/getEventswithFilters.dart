// class GetEventWithFilters {
//   int? code;
//   String? status;
//   String? message;
//   int? count;
//   List<DataOfEventsFilter>? data;
//
//   GetEventWithFilters(
//       {this.code, this.status, this.message, this.count, this.data});
//
//   GetEventWithFilters.fromJson(Map<String, dynamic> json) {
//     code = json['code'];
//     status = json['status'];
//     message = json['message'];
//     count = json['count'];
//     if (json['data'] != null) {
//       data = <DataOfEventsFilter>[];
//       json['data'].forEach((v) {
//         data!.add(new DataOfEventsFilter.fromJson(v));
//       });
//     }
//   }
//
...
//         this.tickets});
//
//   DataOfEventsFilter.fromJson(Map<String, dynamic> json) {
//     id = json['id'];
//     guid = json['guid'];
...
class  GetEventWithFilters {
  ...
  factory  GetEventWithFilters.fromJson(Map<String, dynamic> json) {
    return  GetEventWithFilters(
      code: json['code'],
      status: json['status'],
      message: json['message'],
      count: json['count'],
      data: json['data'] != null
          ? (json['data'] as List)
          .map((eventJson) => DataOfEventsFilter.fromJson(eventJson))
          .toList()
          : null,
    );
  }
...
class DataOfEventsFilter {
  ...
  factory DataOfEventsFilter.fromJson(Map<String, dynamic> json) {
    return DataOfEventsFilter(
      id: json['id'],
      guid: json['guid'],
      categoryId: json['category_id'],
      userId: json['user_id'],
